<?php require 'php/config.php'; session_start(); if(isset($_SESSION['c_admin'])){ header('location:admin/'); }elseif(isset($_SESSION['c_atasan'])){ header('location:atasan/');}elseif(isset($_SESSION['c_pimatasan'])){ header('location:pimatasanlangsung/');}elseif(isset($_SESSION['c_pelaksana'])){ header('location:user/');}?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <title>Login SiSINGA</title>
...
<?php ?>
<body class="hold-transition login-page" style="background:url(theme/dist/img/bc4.jpg)
no-repeat center center fixed; background-size: cover;
 ...
 -moz-background-size: cover; -o-background-size: cover;"><div class="login-box">
  ...
  <p><i class="btn btn-block btn-success btn-flat"></i></p> 
      ...
      <h4 class="text-center">Masukkan Username & Password</h4>
    <p><i class="btn btn-block btn-success btn-flat"></i></p>  
        ...
        <div class="col-xs-12">
          <div class="form-group">
            ...
            <select class="form-control" name="v">
              ...
              <option value="pimatasan">Pimpinan Atasan Langsung</option>
              <option value="pelaksana">User</option>
    ...
    <strong><marquee><a href="#">PENGADILAN NEGERI TARAKAN KELAS I B</a></strong></marquee>
