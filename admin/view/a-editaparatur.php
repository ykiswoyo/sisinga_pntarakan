<?php $aksis=mysqli_query($con,"SELECT * FROM aparatur where c_aparatur='$_GET[q]' ");$hasis=mysqli_fetch_array($aksis);?>
<div class="row">
        <!-- left column -->
        <div class="col-md-12">
        ...
        <?php } $_SESSION['pesan'] = '';?>
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Edit: </h3><span style="float:right;"><a href="<?php echo $basead.'aparatur'; ?>" class="btn btn-circle btn-primary"><i class="glyphicon glyphicon-th-list"></i> Lihat Aparatur Pengadilan Negeri Tarakan</a></span>
            </div>
            <!-- form start -->
            <form role="form" method="post" enctype="multipart/form-data" action="<?php echo $basead; ?>a-control/<?php echo md5('editaparatur'); ?>/access">
            <input type="hidden" name="c_aparatur" value="<?php echo $_GET['q']; ?>">
              <div class="box-body">
                <div class="form-group">
                  <label>NIP</label>
                  <input type="text" required="" name="nip" class="form-control" value="<?php echo $hasis['nip']; ?>">
                </div>
                <div class="form-group">
