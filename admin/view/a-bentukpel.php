...
?>
      <div class="row">
        ...
        <?php if(isset($_SESSION['pesan']) && $_SESSION['pesan']=='edit'){?>
          <div style="display: none;" class="alert alert-success alert-dismissable">Katagori Peraturan Berhasil Diedit
             <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
          </div>
        <?php } ?>
        <?php if(isset($_SESSION['pesan']) && $_SESSION['pesan']=='hapus'){?>
          <div style="display: none;" class="alert alert-danger alert-dismissable">Katagori Peraturan Berhasil Dihapus
             <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
          </div>
        <?php } ?>
        <?php $_SESSION['pesan'] = '';?>
          <div class="box box-info">
            ...
            <?php if(isset($_GET['q'])){ ?>
              <h3 class="box-title"></span>&nbsp;BENTUK PELANGGARAN dari:...<b><?php echo $hjenpel['katbenpel']; ?></b></h3><span style="float:right;"><a href="<?php echo $basead; ?>addbentukpelanggaran/<?php echo $_GET['q']; ?>" class="btn btn-circle btn-primary"><i class="glyphicon glyphicon-plus"></i> Bentuk Pelanggaran</a></span>
            <?php }else{?>
              <h3 class="box-title"></span>&nbsp;JENIS PERATURAN & BENTUK PELANGGARAN</h3>
            <?php } ?>
            </div>
            <!-- /.box-header -->
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="modal-body">
          ...
          <b>1. Data Pelanggaran yang Berhubungan dengan (<?php echo $akh['benpel']; ?>) Secara Keseluruhan Juga Terhapus</b>
        </div>
