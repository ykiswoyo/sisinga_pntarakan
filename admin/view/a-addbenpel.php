...
<div class="row">
        ...
        <?php if(isset($_SESSION['pesan']) && $_SESSION['pesan']=='tambah'){?>
          <div style="display: none;" class="alert alert-info alert-dismissable"> Berhasil Ditambahkan
        ...
        <?php } $_SESSION['pesan'] = '';?>
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Tambah  Pelanggaran dari Peraturan:... <b><?php echo $hjenpel['katbenpel']; ?></b></h3><span style="float:right;"><a href="<?php echo $basead; ?>bentukpelanggaran/<?php echo $_GET['q']; ?>" class="btn btn-circle btn-primary"><i class="glyphicon glyphicon-th-list"></i> Bentuk Pelanggaran</a></span>
            </div>
            <!-- form start -->
