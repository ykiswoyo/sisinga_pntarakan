...
<div class="row">
        ...
        <?php if(isset($_SESSION['pesan']) && $_SESSION['pesan']=='tambah'){?>
          <div style="display: none;" class="alert alert-info alert-dismissable">Tingkat & Jenis Hukuman Disiplin Berhasil Ditambahkan
        ...
        <?php } $_SESSION['pesan'] = '';?>
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">EDIT TINGKAT & JENIS HUKUMAN DISIPLIN</b></h3><span style="float:right;"><a href="<?php echo $basead; ?>sanksipelanggaran" class="btn btn-circle btn-primary"><i class="glyphicon glyphicon-th-list"></i> Data Tingkat & Jenis Hukuman Disiplin</a></span>
            </div>
            <!-- form start -->
