<?php
$jsi=mysqli_query($con,"SELECT * FROM aparatur ");$hsi=mysqli_num_rows($jsi);
$jgu=mysqli_query($con,"SELECT * FROM atasan ");$hgu=mysqli_num_rows($jgu);
$jwa=mysqli_query($con,"SELECT * FROM pimatasan ");$hwa=mysqli_num_rows($jwa);
      ...
      <div class="row">
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box" style="border-bottom: 3px solid #5bc0de;">
            <a href="<?php echo $basead; ?>aparatur"><span class="info-box-icon bg-aqua"><i class="glyphicon glyphicon-user"></i></span></a>

            <div class="info-box-content">
              <span class="info-box-text">HAKIM/PNS/ </span>
              <span class="info-box-text">P3K/PPNPN </span>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box" style="border-bottom: 3px solid #5cb85c;">
            <a href="<?php echo $basead; ?>atasan"><span class="info-box-icon bg-green"><i class="glyphicon glyphicon-user"></i></span></a>

            <div class="info-box-content">
              <span class="info-box-text">Atasan</span>
              <span class="info-box-text">Langsung</span>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box" style="border-bottom: 3px solid #f0ad4e;">
            <a href="<?php echo $basead; ?>pimatasanlangsung"><span class="info-box-icon bg-yellow"><i class="glyphicon glyphicon-user"></i></span></a>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box" style="border-bottom: 3px solid #d9534f;">
            <a href="<?php echo $basead; ?>pelanggaranaparatur"><span class="info-box-icon bg-red"><i class="glyphicon glyphicon-remove-circle"></i></span></a>
...
<div class="row">
<?php $pps=mysqli_query($con,"SELECT c_aparatur, sum(bobot) as jb from pelanggaran group by c_aparatur order by jb desc limit 4 "); while($hpps=mysqli_fetch_array($pps)){ $sis=mysqli_fetch_array(mysqli_query($con,"SELECT * FROM aparatur where c_aparatur='$hpps[c_aparatur]' ")); $kel=mysqli_fetch_array(mysqli_query($con,"SELECT * FROM bagian where c_bagian='$sis[c_bagian]' ")); ?>
  <div class="col-md-3">
    <div class="box box-primary">
      <div class="box-body box-profile">
        ...
        <a href="<?php echo $basead; ?>lihatpelanggaranaparatur/<?php echo $hpps['c_aparatur']; ?>" class="btn btn-primary btn-block"><b>Lihat Pelanggaran</b></a>
      </div>
    </div>
  </div>
<?php } ?>
  ...
  <div class="col-md-4">
    <div class="box">
      <div class="box-header">
        <p>PELANGGARAN YANG SERING DILAKUKAN</p>
        <div class="box-tools">
