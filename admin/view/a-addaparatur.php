...
<div class="row">
        ...
        <?php if(isset($_SESSION['pesan']) && $_SESSION['pesan']=='tambah'){?>
          <div style="display: none;" class="alert alert-success alert-dismissable">Aparatur Berhasil Ditambahkan
        ...
        <?php } $_SESSION['pesan'] = '';?>
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Tambah: <?php echo $dbagian['bagian']; ?></h3><span style="float:right;"><a href="<?php echo $basead.'aparatur/'.$_GET['q']; ?>" class="btn btn-circle btn-primary"><i class="glyphicon glyphicon-th-list"></i> Lihat Aparatur Pengadilan Negeri Tarakan</a></span>
            </div>
            <!-- form start -->
            <form role="form" method="post" enctype="multipart/form-data" action="<?php echo $basead; ?>a-control/<?php echo md5('addaparatur'); ?>/access">
            <input type="hidden" name="c_bagian" value="<?php echo $_GET['q']; ?>">
              <div class="box-body">
              ...
              <div class="box-footer">
                <button type="submit" class="btn btn-success btn-circle"><i class="glyphicon glyphicon-ok"></i> Simpan Aparatur PN Tarakan</button>
              </div>
            </form>
          </div>
          <!-- /.box -->
