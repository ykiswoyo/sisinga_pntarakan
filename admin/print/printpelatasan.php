...
$content.='
<title>LAPORAN PENGAWASAN & PEMBINAAN ('.$gur['nama'].')</title>
...
<table class="table table-bordered">
    <tr class="text-center">
      <td width="1%">NO</td>
      <td>NAMA</td>
      <td width="40%">PELANGGARAN</td>
      <td width="1%">BOBOT</td>
      <td width="10%">TANGGAL</td>
    </tr>';
$smk=mysqli_query($con,"SELECT * FROM pelanggaran where c_atasan='$_GET[atasan]' order by at desc ");$vr=1;while($akh=mysqli_fetch_array($smk)){
...
$dompdf->render();
$dompdf->stream('Laporan dari Atasan Langsung ('.$gur['nama'].').pdf',array("Attachment"=>0));
