<?php date_default_timezone_set('Asia/Jakarta');$date=date('Y-m-d'); require '../php/config.php'; require '../php/function.php'; session_start(); if(empty($_SESSION['c_atasan'])){header('location:../login');} $na=mysqli_fetch_array(mysqli_query($con,"SELECT * FROM atasan where c_atasan='$_SESSION[c_atasan]' ")); //$setting=mysqli_fetch_array(mysqli_query($con,"SELECT * FROM setting limit 1 ")); ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <title>Atasan Langsung</title>
  ...
  <script type="text/javascript">
   var auto_refresh = setInterval(
      function(){
        $('#tampildata').load('../../view/loadpesan.php?atasan=<?php echo $_SESSION['c_atasan']; ?>&ortu=<?php echo $_GET['q'];?>&_=' +Math.random()).show();
      },4000);
  </script>
  <?php if(empty($_GET['q'])){ ?>
  <script type="text/javascript">
   var auto_refresh = setInterval(
      function(){
        $('#pesanbaru').load('view/cekpesanbaru.php?atasan=<?php echo $_SESSION['c_atasan']; ?>&_=' +Math.random()).show();
      },3000);
  </script>
<?php }else{ ?>
  <script type="text/javascript">
...
<script type="text/javascript">
  $(document).ready(function(){
    $('#tampildata').load("../../view/loadpesan.php?atasan=<?php echo $_SESSION['c_atasan']; ?>&ortu=<?php echo $_GET['q'];?>");
    $("#tombol-simpan").click(function(){
      var data = $('#form-kirim').serialize();
      $.ajax({
        type: 'POST',
        url: "<?php echo $basegu; ?>g-control/<?php echo md5('kirimpesanatasan').'/'.$_GET['q']; ?>",
        data: data,
        success: function() {
          $('#tampildata').load("../../view/loadpesan.php?atasan=<?php echo $_SESSION['c_atasan']; ?>&ortu=<?php echo $_GET['q'];?>");
        }
...
<div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <?php } ?>
                <input type="hidden" name="c_atasan" class="form-control" value="<?php echo $_SESSION['c_atasan']; ?>">
...
<div class="wrapper">
  <header class="main-header">
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-lg"><b>Atasan Langsung</b></span>
    </a>
    <!-- Header Navbar: style can be found in header.less -->
    <nav class="navbar navbar-static-top" role="navigation">
      <!-- Sidebar toggle button-->
      <a href="#" class="glyphicon glyphicon-th" data-toggle="offcanvas" role="button" style="color: #fff;margin-top: 15px;margin-left: 13px;font-size: 16px;"> Sistem Informasi Pengawasan & Pembinaan (SiSINGA)</a>
        ...
        <?php }*/ ?>
          ...
          <li class="dropdown notifications-menu">
            ...
            <ul class="dropdown-menu" style="border-bottom: 2px solid#aaa;">
              <li class="header text-center">Masukkan NAMA atau NIP</li>
              <li>
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            <?php if($na['foto']==NULL){ ?>
              <img src="<?php echo $base; ?>php/img/admin.png" class="user-image" alt="User Image">
            <?php }else { ?> 
            ...
            <ul class="dropdown-menu">
              ...
              <?php if($na['foto']==NULL){ ?>
                <img src="<?php echo $base; ?>php/img/admin.png" class="img-circle" alt="User Image">
              <?php }else { ?> 
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="<?php echo $base; ?>php/img/logopntarakan.ico" class="img-circle" alt="User Image">
        </div>
        <div class="pull-left info">
          <p><?php echo $na['inisial']; ?></p>  
      ...
      <ul class="sidebar-menu">
        ...
        <li <?php echo $bak; ?>>
          <a href="<?php echo $basegu; ?>inputpelanggaran">
            <i class="glyphicon glyphicon-new-window"></i> <span>Input Pelanggaran</span>
          </a>
        </li>
        <li <?php echo $cak; ?>>
        ...
        <li>
          <a href="<?php echo $basegu; ?>pimatasanlangsung">
...
<?php
  if(empty($_GET['smkakh'])){require 'view/home.php';}
    ...
    if($act=='inputpelanggaran'){
      ...
      require 'view/detpelaparatur.php';
    }
    else if($act=='pimatasanlangsung'){
      require 'view/pimatasanlangsung.php';
    }
