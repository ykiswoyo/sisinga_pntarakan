<div class="row">
  <div class="col-md-4">
    <div class="box box-solid">
      <div class="box-header with-border">
      	<h3 class="box-title">Pimpinan Atasan Langsung</h3>
      ...
      <?php $relc=mysqli_query($con,"SELECT * FROM pimatasan ");while($hrel=mysqli_fetch_array($relc)){ ?>
                <li <?php if(isset($_GET['q'])){if($_GET['q']==$hrel['c_pimatasan']){echo 'class="active"';}} ?> ><a href="<?php echo $basegu; ?>pesan/<?php echo $hrel['c_pimatasan']; ?>/_"><?php echo $hrel['nama']; ?></a></li>
  ...
  <div class="col-md-8">
        ...
        <div class="box-body">
          ...
          <div class="direct-chat-messages">
            <div class="direct-chat-msg">
              <img class="direct-chat-img" src="<?php echo $base; ?>theme/dist/img/wa1.jpg" alt="message user image">
    ...
    <?php }else {  $pimatasan=mysqli_fetch_array(mysqli_query($con,"SELECT * FROM pimatasan where c_pimatasan='$_GET[q]' "));  ?>
        ...
        <div class="box-header">
          <h3 class="box-title">Percakapan Anda Dengan <?php echo $pimatasan['nama']; ?></h3>
...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <b>1. Seluruh Percakapan Dengan (<?php echo $pimatasan['nama']; ?>) Secara Keseluruhan Juga Terhapus</b>
        </div>
