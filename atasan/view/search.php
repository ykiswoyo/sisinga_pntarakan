    ...
    <div class="box box-widget widget-user-2">
      ...
      <div class="box-footer no-padding">
        <ul class="nav nav-stacked">
          ...
          <li><a>Pimpinan Atasan Langsung <span class="pull-right"><?php if($pimatasan['nama']==NULL){echo '-';}else{ echo $pimatasan['nama'];} ?></span></a><li>
  ...
  <div class="col-xs-12 col-md-8 col-lg-8">
    <div class="box box-info">
      <div class="box-header with-border">
        <h3 class="box-title">&nbsp;Pelanggaran <?php echo $sea['nama'] ?></h3><span class="pull-right"><a target="_blank" class="btn bg-blue btn-sm" href="<?php echo $basegu.'print/printpelaparatur?aparatur='.$sea['c_aparatur']; ?>"><i class="glyphicon glyphicon-print"></i> Print</a></span>
      </div>
      <div class="box-body">
