<div class="row">
  <div class="col-md-4">
    <div class="box box-solid">
      ...
      <?php $relc=mysqli_query($con,"SELECT * FROM relasichat where c_pimatasan='$_SESSION[c_pimatasan]' ");while($hrel=mysqli_fetch_array($relc)){ $or=mysqli_fetch_array(mysqli_query($con,"SELECT * FROM atasan where c_atasan='$hrel[c_atasan]' ")); ?>
                <li <?php if(isset($_GET['q'])){if($_GET['q']==$hrel['c_atasan']){echo 'class="active"';} }?> ><a href="<?php echo $basewa; ?>pesan/<?php echo $hrel['c_atasan']; ?>/_"><?php echo $or['nama']; ?><i class="fa fa-inbox"></i> 
  ...
  <div class="col-md-8">
    ...
    <?php }else {  $gu=mysqli_fetch_array(mysqli_query($con,"SELECT * FROM atasan where c_atasan='$_GET[q]' "));  ?>
