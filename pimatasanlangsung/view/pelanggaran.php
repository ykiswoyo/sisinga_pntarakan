  ...
  <div class="col-xs-12 col-md-8 col-lg-8">
    <div class="box box-info">
      <div class="box-header with-border">
        <h3 class="box-title">&nbsp;Pelanggaran <?php echo $aparatur['nama'] ?></h3><p class="pull-right"><a target="_blank" class="btn bg-blue btn-sm" href="<?php echo $basewa.'print/printpelaparatur?aparatur='.$aparatur['c_aparatur'].''; ?>"><i class="glyphicon glyphicon-print"></i> Print</a></p>
      </div>
      <div class="box-body">
